    ...
    public class UdpSessionReceiver extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                // Bind on all interfaces so telemetry is received even if the
                // detected local IP is stale or differs from the routing IP.
                socket.bind(new InetSocketAddress(PORT));
                socket.setSoTimeout(0); // infinite timeout
                try {
                    // full OutGauge struct is 96 bytes (+ optional odometer = 100)
